...
{
    if (isset($streuner[$x])) echo $streuner[$x];
}
?>
...
{
    if (isset($menschen[$x]))echo $menschen[$x];
}
?>
...
{
    if (isset($heldenpower[$x])) echo $heldenpower[$x];
}
?>
        ]
    }
...
{
    if (isset($waffenpower[$x])) echo $waffenpower[$x];
}
?>
        ]
    },
...
{
    if (isset($gerettete[$x])) echo $gerettete[$x];
}
?>
        ]
    }
